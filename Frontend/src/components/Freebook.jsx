...
function Freebook() {
    const filterData = list.filter((data) => data.category === "Online");
    var settings = {
        dots: true,
        infinite: true,
        slidesToShow: 3,
    ...
    return (
        <>
            ...
            <div className="">
                <h1 className="text-yellow-400 font-bold text-xl pb-2 pt-20 max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row">Internship Partners:</h1>
            ...
            <div className="slider-container overflow-hidden px-8 py-2 text-center">
                <Slider {...settings}>
                    {/* <div>
                        <h3>1</h3>
                    </div>
